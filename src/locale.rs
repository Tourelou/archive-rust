...
pub const LANG_FR: ArchiveStrings = ArchiveStrings {
	options: OPTIONS_FR,
	usage: "<-f motif> | <-s dossier>",
	description: "Trouve un motif ou scan un volume vers un fichier texte, version",
...
pub const LANG_EN: ArchiveStrings = ArchiveStrings {
	options: OPTIONS_EN,
	usage: "-<f pattern> | <-s folder>",
	description: "Find a pattern or scan a volume to a text file, version",
...
pub const LANG_ES: ArchiveStrings = ArchiveStrings {
	options: OPTIONS_ES,
	usage: "<-f Patrón> | <-s directorio>",
	description: "Buscar un patrón o escanear un volumen a un archivo de texto, versión",
...
pub fn get_app_lang() -> ArchiveStrings {
